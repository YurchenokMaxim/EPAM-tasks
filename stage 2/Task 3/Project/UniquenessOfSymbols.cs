...
namespace Uniqueness
{
    public class UniquenessOfSymbols
    {
        ...
        /// <summary>
        /// This method finds the largest sequence of non repeat symbols and return length of this.
        /// </summary>
        ...
        /// <summary>
        /// This method finds the largest absolute uniqueness sequence of symbols in line and return length of this.
        /// </summary>
        /// <param Line with different symbols ="entry"></param>
        ...
        /// <summary>
        /// This method returns the largest line of identical latin letters.
        /// </summary>
        /// <param Line with different symbols ="entry"></param>
        /// <returns></returns>
        public static int GetLengthOfLineOfIdenticalLatinLetters(string entry)
        {
            if (String.IsNullOrEmpty(entry))
            {
                throw new Exception("The input data has zero length or equals null");
            ...
            int sum = 0;
            int result = 0;
            if ( ((line[0] <= 'Z' && line[0] >= 'A') || (line[0] <= 'z' && line[0] >= 'a')))
            {
                result = 1;
            }
            ...
            {
                if (line[index] == line[index - 1] && ((line[index] <= 'Z' && line[index] >= 'A') || (line[index] <= 'z' && line[index] >= 'a')))
                {
                    sum++;
                }
                else
        ...
        /// <summary>
        /// This method returns the largest line of identical numbers.
        /// </summary>
        /// <param Line with different symbols ="entry"></param>
        /// <returns></returns>
        public static int GetLengthOfLineOfIdenticalNumbers(string entry)
        {
            if (String.IsNullOrEmpty(entry))
            {
                throw new Exception("The input data has zero length or equals null");
            ...
            for (int index = 1; index < line.Length; index++)
            {
                if ((line[index] == line[index - 1]) && (line[index] <= 57 && line[index] >= 48))
                {
                    sum++;
                }
                else
