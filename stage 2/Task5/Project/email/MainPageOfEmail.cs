...
namespace Task9
{
    public class MainPageOfEmail
    {
        ...
        public MainPageOfEmail(IWebDriver browser)
        {
            this.browser = browser;
            IWebElement settingsButton = browser.FindElement(By.XPath(settingsButtonXPath));
            writeLetterButton = browser.FindElement(By.XPath(writeLetterButtonXPath));
        }
        ...
        public string ExitFromEmail()
        {
            IWebElement settingsButton = browser.FindElement(By.XPath(settingsButtonXPath));
            settingsButton.Click();
            exitButton = browser.FindElement(By.XPath(exitButtonXPath));
            exitButton.Click();
        ...
        public string AnswerMessage(string answer)
        {
            ...
            filter = browser.FindElement(By.ClassName(filterClassName));
            filter.Click();
            unreadMessagesButton = browser.FindElement(By.Id(unreadMessagesButtonId));
            unreadMessagesButton.Click();
            letterForAnswer = browser.FindElement(By.ClassName(letterForAnswerClassName));
