...
namespace CarPark
{
    ...
    public abstract class Vehicle : IInformation
    {
        ...
        {
            if (speed <= 0 || transmission == null || chassis == null || engine == null)
            {
                throw new InitializationException("It is not available to initialize a vehicle with these parameters");
            }
